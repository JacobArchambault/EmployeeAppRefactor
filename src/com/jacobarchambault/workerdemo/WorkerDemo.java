...
public class WorkerDemo {
	...
	public static void main(String[] args) {
		...
		new TeamLeader("John Smith", "123-A", LocalDate.of(1999, 4, 21), ProductionWorker.DAY_SHIFT, 16.50, 500.00,
				5.0, 2.5)
		// Display the data.
		.info("Here's the first team leader.");

		// Create another TeamLeader object.
		new TeamLeader("Joan Jones", "222-L", LocalDate.now(), ProductionWorker.NIGHT_SHIFT, 18.50, 10000,
				30, 10)
